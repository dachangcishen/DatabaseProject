...
public class Database{
    ...
    public void listAllSalespersons(int sortMode) throws SQLException {
    ...
    public void listSalesPersonsWithTransactionNumber(int lowerLimit, int higherlimit) throws SQLException{
    ...
    public void listManufacturersWithTotalSalesValue() throws SQLException{
        Statement stmt = con.createStatement();
    ...
    public void showNMostPopularParts(int n) throws SQLException{
        Statement stmt = con.createStatement();
